package com.github.zhangkaitao.shiro.chapter11.token;
 ...
 * @since 0.1
 */
public class ObjectToken implements HostAuthenticationToken, RememberMeAuthenticationToken {
     ...
     */
    public ObjectToken(final Object user, final char[] password) {
     ...
     */
    public ObjectToken(final  Object user, final String password) {
        this(user, password != null ? password.toCharArray() : null, false, null);
    }
     ...
     * @since 0.2
     */
    public ObjectToken(final  Object user, final char[] password, final String host) {
        this(user, password, false, host);
    }
     ...
     * @since 1.0
     */
    public ObjectToken(final  Object user, final String password, final String host) {
        this(user, password != null ? password.toCharArray() : null, false, host);
    }
     ...
     * @since 0.9
     */
    public ObjectToken(final  Object user, final char[] password, final boolean rememberMe) {
        this(user, password, rememberMe, null);
    }
     ...
     * @since 0.9
     */
    public ObjectToken(final  Object user, final String password, final boolean rememberMe) {
        this(user, password != null ? password.toCharArray() : null, rememberMe, null);
    }
    ...
    public ObjectToken(final  Object user, final String password,
                                 final boolean rememberMe, final String host) {
        this(user, password != null ? password.toCharArray() : null, rememberMe, host);
    }
     ...
     */
    public void setUsername(Object user) {
        this.user = user;
    }
